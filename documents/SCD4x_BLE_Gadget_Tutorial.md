...
Connect the SEK-SCD41 module to the ESP32 DevKitC as depicted below:

* **VDD** of the SEK-SCD41 to the **3.3V** of the ESP32
* **GND** of the SEK-SCD41 to the **GND** of the ESP32
* **SCL** of the SEK-SCD41 to the **GPIO 22** of the ESP32
* **SDA** of the SEK-SCD41 to the **GPIO 21** of the ESP32
